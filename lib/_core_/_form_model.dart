...
abstract class FormModel<
  ...
  Future<bool> _unitFormViewChanged({
    ...
    await _startNewFormTransaction(
      extraFormInput: null,
      filterCriteria: block._blockData.filterCriteria,
  ...
  Future<bool> _unitLoadForm({required _XFormModel thisXFormModel}) async {
    ...
    __loadCount++;
    //
    FILTER_CRITERIA? filterCriteria = this.block._blockData.filterCriteria;
  ...
  Future<bool> _unitSaveForm({required _XFormModel thisXFormModel}) async {
    ...
    try {
      ...
      Object? parentBlockItem = block.parent?._blockData.currentItem;
      //
  ...
  Future<bool> _startNewFormTransaction({
    ...
    final ITEM_DETAIL? itemDetail = block._blockData.currentItemDetail;
  ...
  Future<void> _loadMultiOptPropDataCascade({
    ...
    final ITEM_DETAIL? currentItemDetail = block._blockData.currentItemDetail;
    //
    if (multiOptPropXData != null) {
      if (isItemFirstLoad) {
