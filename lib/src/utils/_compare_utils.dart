...
class ComparisonUtils {
  ...
  ///
  static bool compareDynamicAndDynamic(dynamic value, dynamic other) {
  ...
  /// This function is used to check for "dirty" in a form.
  ///
  static bool _compareMapAndMap(Map map, Map other) {
    Set<dynamic> keys = {}
      ..addAll(map.keys)
      ..addAll(other.keys);
 ...
 static bool _compareIterableAndIterable(Iterable iterable, Iterable other) {
  ...
  /// This function is used to check for "dirty" in a form.
  ///
  static bool _compareIterableAndDynamic(Iterable iterable, dynamic other) {
    if (iterable.isEmpty) {
      if (other == null) {
        return true;
      } else if (other is Iterable) {
