...
class FilterCriterionConditionModelView extends StatelessWidget {
  final FilterCriterionConditionModel criterionConditionModel;

  const FilterCriterionConditionModelView({
    super.key,
    required this.criterionConditionModel,
  });

  @override
  Widget build(BuildContext context) {
    final FilterCriterionModel criterionModel =
        criterionConditionModel.criterionModel;
    //
        ...
        children: [
          ListTile(
            ...
            title: IconLabelSelectableText(
              ...
              text: criterionConditionModel.criterionNamePlus,
            ...
            subtitle: Column(
              ...
              children: [
                ...
                IconLabelSelectableText(
                  label: "Operator: ",
                  text: criterionConditionModel.operator.name,
                  labelStyle:
                      TextStyle(fontSize: 12, fontWeight: FontWeight.bold),
                  textStyle: TextStyle(
                    fontSize: 12,
                ...
                IconLabelSelectableText(
                  ...
                  text: criterionConditionModel.supportedOperators
                      .map((o) => o.text)
                      .toList()
                      .toString(),
                  labelStyle:
          ...
          if (criterionModel is MultiOptFilterCriterionModel)
            LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                return RadioGroup(
                  onChanged: (_) {},
                  groupValue: criterionModel.selectionType,
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
