...
class StorageDialogOLD extends StatefulWidget {
  final Shelf? shelf;

  const StorageDialogOLD({
    required this.shelf,
    super.key,
  });

  @override
  State<StorageDialogOLD> createState() {
    return _StorageDialogOLDState();
  }
  ...
  static Future<void> showStorageDialog({
    ...
    await showDialog(
      ...
      builder: (BuildContext context) {
        return StorageDialogOLD(shelf: shelf);
      },
    );
  }
}

class _StorageDialogOLDState extends State<StorageDialogOLD> {
  Shelf? _currentShelf;
