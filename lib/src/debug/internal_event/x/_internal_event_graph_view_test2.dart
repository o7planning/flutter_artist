...
class InternalEventGraphViewTest2 extends StatefulWidget {
  @override
  State<InternalEventGraphViewTest2> createState() =>
      _InternalEventGraphViewTest2State();
}

class _InternalEventGraphViewTest2State
    extends State<InternalEventGraphViewTest2> {
  @override
  ...
  void initState() {
    ...
    Edge edge1 = graph.addEdge(node1, node13,
        paint: Paint()
          ..color = Colors.red
          ..strokeWidth = 3);
