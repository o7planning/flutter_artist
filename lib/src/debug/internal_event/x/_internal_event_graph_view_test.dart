...
class InternalEventGraphViewTest extends StatefulWidget {
  @override
  State<InternalEventGraphViewTest> createState() =>
      _InternalEventGraphViewTestState();
}

class _InternalEventGraphViewTestState
    extends State<InternalEventGraphViewTest> {
  @override
  ...
  void initState() {
    ...
    graph.addEdge(b, a, paint: Paint()..color = Colors.blue);
    graph.addEdge(a, c);
    graph.addEdge(a, d);
    graph.addEdge(c, e);
    graph.addEdge(d, f);
