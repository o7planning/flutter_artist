...
abstract class Shelf extends _Core {
  ...
  void __registerScalarCascade(Scalar scalar) {
    ...
    if (scalar.registeredFilterModelName != null) {
      ...
      if (filterModel == null) {
        throw ___registerError(
            "FilterModel not found '${scalar.registeredFilterModelName}' in '${getClassName(this)}'\n"
            "Double-check ${getClassName(this)}.defineShelfStructure() method");
      }
      //
      //
  ...
  void __registerBlockCascade(Block block) {
    ...
    if (block.registeredFilterModelName != null) {
      ...
      if (filterModel == null) {
        throw ___registerError(
            "FilterModel not found '${block.registeredFilterModelName}' in '${getClassName(this)}'\n"
            "Double-check ${getClassName(this)}.defineShelfStructure() method");
      }
      //
      //
  ...
  /// Evaluates whether this Shelf permits receiving external events from [sourceShelf].
  bool canAcceptEventFrom(Shelf sourceShelf) {
    return effectiveConfig.canAcceptEventFrom(sourceShelf.effectiveConfig);
  }
