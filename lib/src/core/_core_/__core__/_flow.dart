...
abstract class Flow<
  ...
  FlowDataState _dataState = FlowDataStateNone();
  ...
  late final ui = _FlowUiComponents(flow: this);
  ...
  XFlow<STAGE_ENUM, FLOW_CONTEXT_DATA> _createXFlow({
    required XActivity xActivity,
  }) {
    return XFlow<STAGE_ENUM, FLOW_CONTEXT_DATA>._(
      flow: this,
      xActivity: xActivity,
    );
  }
